...
\begin{tikzpicture}[mark=star]
    \pgfplotstableread[col sep=comma]{csv_data/stickmen_out_single.csv}\csvstickmendesktop
    \begin{axis}[
            height=6cm,
            width=0.9\textwidth,
            ...
            ticklabel style={font=\tiny},
            ylabel={\small Time (sec)}
        ]
        \foreach \n in {1,...,6} {
            \addplot table [y index=\n] {\csvstickmendesktop};
        }
        \legend{Scattered-Aos,Pooled-Aos,Scattered-Mixed,Pooled-Mixed,Scattered-Soa,Pooled-Soa}
    \end{axis}
\end{tikzpicture}
